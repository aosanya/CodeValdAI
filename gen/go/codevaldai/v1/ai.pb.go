...
type Agent struct {
	...
	BudgetTokens       int32                  `protobuf:"varint,15,opt,name=budget_tokens,json=budgetTokens,proto3" json:"budget_tokens,omitempty"`                     // 0 = provider default; set for reasoning models
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *AgentRun) GetWorkflowRunId() string {
	if x != nil {
...
func (x *IntakeRunRequest) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *IntakeRunRequest) GetWorkflowRunId() string {
	if x != nil {
		return x.WorkflowRunId
	}
	return ""
...
type ListRunsRequest struct {
	...
	WorkflowRunId string                 `protobuf:"bytes,4,opt,name=workflow_run_id,json=workflowRunId,proto3" json:"workflow_run_id,omitempty"` // empty = no filter
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListRunsRequest) GetWorkflowRunId() string {
	if x != nil {
		return x.WorkflowRunId
	}
	return ""
...
const file_codevaldai_v1_ai_proto_rawDesc = "" +
	...
	"\vprovider_id\x18\x01 \x01(\tR\n" +
	"providerId\"\x18\n" +
	"\x16DeleteProviderResponse\"\xbe\x04\n" +
	"\x05Agent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	...
	"\x14session_max_sessions\x18\x0e \x01(\x05R\x12sessionMaxSessions\x12#\n" +
	"\rbudget_tokens\x18\x0f \x01(\x05R\fbudgetTokens\"\xc5\x03\n" +
	...
	"\x14session_max_sessions\x18\v \x01(\x05R\x12sessionMaxSessions\x12#\n" +
	"\rbudget_tokens\x18\f \x01(\x05R\fbudgetTokens\",\n" +
	"\x0fGetAgentRequest\x12\x19\n" +
	"\bagent_id\x18\x01 \x01(\tR\aagentId\"\x13\n" +
	"\x11ListAgentsRequest\"B\n" +
	"\x12ListAgentsResponse\x12,\n" +
	"\x06agents\x18\x01 \x03(\v2\x14.codevaldai.v1.AgentR\x06agents\"\xe0\x03\n" +
	...
	"\x14session_max_sessions\x18\f \x01(\x05R\x12sessionMaxSessions\x12#\n" +
	"\rbudget_tokens\x18\r \x01(\x05R\fbudgetTokens\"/\n" +
	"\x12DeleteAgentRequest\x12\x19\n" +
	"\bagent_id\x18\x01 \x01(\tR\aagentId\"\x15\n" +
	"\x13DeleteAgentResponse\"\xaf\x05\n" +
	"\bAgentRun\x12\x0e\n" +
	...
	"\x0epartial_output\x18\x10 \x01(\tR\rpartialOutput\x12&\n" +
	"\x0fworkflow_run_id\x18\x11 \x01(\tR\rworkflowRunId\"\xb8\x01\n" +
	"\bRunField\x12\x0e\n" +
	...
	"\finstructions\x18\x02 \x01(\tR\finstructions\x12\x17\n" +
	"\atask_id\x18\x03 \x01(\tR\x06taskId\x12&\n" +
	"\x0fworkflow_run_id\x18\x04 \x01(\tR\rworkflowRunId\"o\n" +
	...
	"\x06run_id\x18\x01 \x01(\tR\x05runId\"\xa4\x01\n" +
