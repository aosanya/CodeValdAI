...
|---|---|---|---|
| MVP-AI-001 | Module scaffolding — go.mod, Makefile, buf.yaml, directory structure | � In Progress | — |
| MVP-AI-002 | Domain models — `models.go` (Agent, AgentRun, AgentRunStatus, RunField, RunInput, request/filter types) | 🔲 Not Started | MVP-AI-001 |
