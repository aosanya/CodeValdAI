...
| FEAT-20260604-001 | Planner dispatch — add `task.plan.split` / `task.plan.decompose` as allowed action topics; normalize planner payload (task_id, workflow_run_id); dispatch via Cross publisher | 🚀 In Progress | — |
