...
| GAP-20260604-001 | `bootstrap.go` agent-already-exists path calls `UpdateAgent`; `aiAgentSpec` extended with `session_max_*` fields — bumps in agency.json now take effect on restart | 🚀 In Progress | — |
